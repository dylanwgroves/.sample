...
/* Load Data ___________________________________________________________________*/	
	...
	insheet using "${spotlight}\01 Data\04 Raw Data\spotlight_master.csv", clear
...
/* Export ______________________________________________________________________*/
	...
	save "$spotlight\01 Data\06 Final Data\spotlight_master_clean.dta", replace

	export excel using "$spotlight\01 Data\06 Final Data\spotlight_master_clean.xlsx", ///
						firstrow(variables) nolabel replace

	export delimited using "X:\Box Sync\Dissertation - Spotlight\01 Data\06 Final Data\spotlight_master_clean.csv", ///
							nolabel replace
