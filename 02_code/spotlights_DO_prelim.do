...
/* Run Prelim File _____________________________________________________________*/ // comment out if you dont need to rerun prelim cleaning	
	...
	*do "${spotlights_code}/XXXXXX.do"
	*do "${spotlights_code}/XXXXXX.do"


/* Load Data ___________________________________________________________________*/	

	use "${spotlights_data}/03_final/spotlights_survey_all_final.dta", clear
	

/* Get only DO Data ____________________________________________________________*/

	keep svy_* resp_* do_* uid block journo_* ward_* dist_*
	rename do_* *
	keep if resp_target == 0 
	gen id = svy_village_uid

/* Outcome Variables ___________________________________________________________*/
	...
	* create dummies 
	...
	lab var ministry_score "Ministry Score"
	
	
	** Create Cluster
	clonevar cluster = svy_village_uid
...
/* Merge RI ____________________________________________________________________*/
	...
	merge 1:1 id using "${spotlights_data}/03_final/spotlights_ri.dta", gen(_merge_ri)

	
/* Save ________________________________________________________________________*/

	save "${spotlights_data}/03_final/spotlights_DO_analysis.dta", replace

stop
/* Crosstabs ___________________________________________________________________*/
