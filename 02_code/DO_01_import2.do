* import_spotlight_survey_DO.do
*
* 	Imports and aggregates "spotlight_survey_DO" (ID: spotlight_survey_DO) data.
*
*	Inputs:  "X:/Box Sync/Dissertation - Spotlight/01 Data/04 Raw Data/02_survey/spotlight_survey_DO_WIDE.csv"
*	Outputs: "X:/Box Sync/Dissertation - Spotlight/01 Data/05 Mid Data/spotlight_survey_DO.dta"
*
*	Output by SurveyCTO December 3, 2021 10:44 AM.
...
local csvfile "X:/Box Sync/Dissertation - Spotlight/01 Data/04 Raw Data/02_survey/spotlight_survey_DO_WIDE.csv"
local dtafile "X:/Box Sync/Dissertation - Spotlight/01 Data/05 Mid Data/spotlight_survey_DO.dta"
local corrfile "X:/Box Sync/Dissertation - Spotlight/01 Data/04 Raw Data/02_survey/spotlight_survey_DO_corrections.csv"
local note_fields1 ""
...
local text_fields4 "oth_text_* oth_audio_* oth_image_* oth_video_* leader_veo_name leader_veo_phone leader_veo_phone2 leader_weo_name leader_weo_phone leader_weo_phone2 leader_diwani_name leader_diwani_phone"
local text_fields5 "leader_diwani_phone2 other_audio other_text comments instanceid"
local date_fields1 ""
...
if _N>0 {
	...
	* label variables
	...
	label variable leader_veo_name "What is the full name of the VEO?"
	note leader_veo_name: "What is the full name of the VEO?"

	label variable leader_veo_female "What is the gender of the VEO"
	note leader_veo_female: "What is the gender of the VEO"
	label define leader_veo_female 0 "Male" 1 "Female"
	label values leader_veo_female leader_veo_female

	label variable leader_veo_age "What is the approximate age of the VEO?"
	note leader_veo_age: "What is the approximate age of the VEO?"

	label variable leader_veo_education "What is the highest level of VEO education?"
	note leader_veo_education: "What is the highest level of VEO education?"
	label define leader_veo_education 1 "Yes" 0 "No"
	label values leader_veo_education leader_veo_education

	label variable leader_veo_inside "Is the VEO from the same Region as the village/street?"
	note leader_veo_inside: "Is the VEO from the same Region as the village/street?"
	label define leader_veo_inside 1 "Yes" 0 "No"
	label values leader_veo_inside leader_veo_inside

	label variable leader_veo_phone "What is the primary phone number of the VEO?"
	note leader_veo_phone: "What is the primary phone number of the VEO?"

	label variable leader_veo_phone2 "What is the alternative phone number of the VEO?"
	note leader_veo_phone2: "What is the alternative phone number of the VEO?"

	label variable leader_weo_name "What is the full name of the weo?"
	note leader_weo_name: "What is the full name of the weo?"

	label variable leader_weo_female "What is the gender of the weo"
	note leader_weo_female: "What is the gender of the weo"
	label define leader_weo_female 0 "Male" 1 "Female"
	label values leader_weo_female leader_weo_female

	label variable leader_weo_age "What is the approximate age of the weo?"
	note leader_weo_age: "What is the approximate age of the weo?"

	label variable leader_weo_education "What is the highest level of weo education?"
	note leader_weo_education: "What is the highest level of weo education?"
	label define leader_weo_education 1 "Yes" 0 "No"
	label values leader_weo_education leader_weo_education

	label variable leader_weo_inside "Is the weo from the same Region as the village/street?"
	note leader_weo_inside: "Is the weo from the same Region as the village/street?"
	label define leader_weo_inside 1 "Yes" 0 "No"
	label values leader_weo_inside leader_weo_inside

	label variable leader_weo_phone "What is the primary phone number of the weo?"
	note leader_weo_phone: "What is the primary phone number of the weo?"

	label variable leader_weo_phone2 "What is the alternative phone number of the weo?"
	note leader_weo_phone2: "What is the alternative phone number of the weo?"

	label variable leader_diwani_name "What is the full name of the diwani?"
	note leader_diwani_name: "What is the full name of the diwani?"

	label variable leader_diwani_female "What is the gender of the diwani"
	note leader_diwani_female: "What is the gender of the diwani"
	label define leader_diwani_female 0 "Male" 1 "Female"
	label values leader_diwani_female leader_diwani_female

	label variable leader_diwani_age "What is the approximate age of the diwani?"
	note leader_diwani_age: "What is the approximate age of the diwani?"

	label variable leader_diwani_education "What is the highest level of diwani education?"
	note leader_diwani_education: "What is the highest level of diwani education?"
	label define leader_diwani_education 1 "Yes" 0 "No"
	label values leader_diwani_education leader_diwani_education

	label variable leader_diwani_inside "Is the diwani from the same Region as the village/street?"
	note leader_diwani_inside: "Is the diwani from the same Region as the village/street?"
	label define leader_diwani_inside 1 "Yes" 0 "No"
	label values leader_diwani_inside leader_diwani_inside

	label variable leader_diwani_phone "What is the primary phone number of the diwani?"
	note leader_diwani_phone: "What is the primary phone number of the diwani?"

	label variable leader_diwani_phone2 "What is the alternative phone number of the diwani?"
	note leader_diwani_phone2: "What is the alternative phone number of the diwani?"
...
*
*   Corrections file path and filename:  X:/Box Sync/Dissertation - Spotlight/01 Data/04 Raw Data/02_survey/spotlight_survey_DO_corrections.csv
*
